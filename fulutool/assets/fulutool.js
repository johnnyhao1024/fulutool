(function () {
  ...
  const PAGE_BINDINGS = {
    ...
    '/pdf-compress.html': {
      title: { zh: '免费 PDF 压缩工具 · 福禄工具箱', en: 'PDF Compressor · Fulutool Toolbox' },
      text: [
        { selector: '.ft-brand-copy small', zh: '免费使用·无需注册·即用即走', en: 'Free to use · No sign-up · Instant access' },
        { selector: '.tool-title', zh: '🗜️ PDF 压缩工具', en: '🗜️ PDF Compressor' },
        { selector: '.tool-desc', zh: '上传 PDF 文档，一键进行无损优化压缩，尽量减少文件体积并保持原始清晰度', en: 'Upload a PDF and run one-click lossless optimization to reduce size while preserving visual quality.' },
        { selector: '#selectPdfBtn', zh: '📂 选择 PDF 文件', en: '📂 Choose PDF file' },
        { selector: '#compressBtn', zh: '⚡ 开始压缩', en: '⚡ Start compression' },
        { selector: '#savePdfBtn', zh: '💾 保存文件', en: '💾 Save file' },
        { selector: '.preview-title', zh: '📈 任务状态', en: '📈 Task status' },
        { selector: '#taskStageLabel', zh: '任务阶段', en: 'Task stage' },
        { selector: '.section-label', zh: '🧩 其他工具 · 点击切换', en: '🧩 More tools · Jump around' },
    ...
    '/old-calendar.html': {
      title: { zh: '老挂历海报生成器 · 福禄工具箱', en: 'Vintage Calendar Poster Generator · Fulutool Toolbox' },
      text: [
        { selector: '.ft-brand-copy small', zh: '免费使用·无需注册·即用即走', en: 'Free to use · No sign-up · Instant access' },
        { selector: '.tool-title', zh: '🗓️ 老挂历海报生成器', en: '🗓️ Vintage Calendar Poster Generator' },
        { selector: '.tool-desc', zh: '上传照片并选择年月，一键生成90年代风格老挂历海报，自动写入真实日历信息', en: 'Upload your photo, pick a year and month, and generate a 90s-style vintage calendar poster with real date data.' },
        { selector: '#selectPhotoBtn', zh: '📂 选择照片', en: '📂 Choose photo' },
        { selector: '#generateBtn', zh: '⚡ 开始生成', en: '⚡ Start generation' },
    ...
    '/puzzle.html': {
      ...
      text: [
        ...
        { selector: '.tool-desc', zh: '按原始像素拼接多张图片，导出无损 PNG', en: 'Combine images at original pixel size and export a lossless PNG' },
  ...
  const TEXT_TRANSLATIONS = {
    zh: new Map([
      ...
      ['Combine images at original pixel size and export a lossless PNG', '按原始像素拼接多张图片，导出无损 PNG'],
      ['上传多张图片，按原始像素拼接，生成无损 PNG 并保存', 'Upload multiple images, combine them at original pixel size, and save a lossless PNG'],
    ...
    en: new Map([
      ...
      ['📘 PDF 转 Word 工具', '📘 PDF to Word Converter'],
      ['上传 PDF 文档，一键进行无损优化压缩，尽量减少文件体积并保持原始清晰度', 'Upload a PDF and run one-click lossless optimization to reduce size while preserving visual quality.'],
      ...
      ['为图片添加文字水印，支持平铺模式，可调节颜色、透明度、大小和旋转角度（实时预览）', 'Add text watermarks with tiled mode, adjustable color, opacity, size and rotation (live preview)'],
      ['为图片添加文字水印，支持平铺、透明度和旋转。', 'Add text watermarks with opacity, angle and tiled layouts'],
      ['按原始像素拼接多张图片，导出无损 PNG', 'Combine images at original pixel size and export a lossless PNG'],
      ['上传多张图片，按原始像素拼接，生成无损 PNG 并保存', 'Upload multiple images, combine them at original pixel size, and save a lossless PNG'],
      ['多图拼接，支持横向/纵向模板，拖拽排序。', 'Combine multiple images into a neat horizontal, vertical, or grid layout'],
